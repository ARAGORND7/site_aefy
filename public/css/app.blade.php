...
#app-layout > div.container > div:nth-child(2) > div > div > div.container {
max-width: 1235px;
}

html body#app-layout div.container div.row div.col-md-12 div.panel.panel-default div.container {
margin: 15px;
}
...
background-image: -webkit-linear-gradient(#1636B7, #004fb7, #004fb7, #004fb7, #1636B7);
background-image: -o-linear-gradient(#1636B7, #004fb7, #004fb7, #004fb7, #1636B7);
background-image: -webkit-gradient(linear,  left top,  left bottom,  from(#54b4eb),  color-stop(60%,  #2fa4e7),  to(#1d9ce5));
background-image: linear-gradient(#1636B7, #004fb7, #004fb7, #004fb7, #1636B7);
background-repeat: no-repeat;
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff54b4eb',  endColorstr='#ff1d9ce5',  GradientType=0);
/*border-bottom: 1px solid #054dc5;*/
-webkit-filter: none;
filter: none;
...
.panel-title-black img{
padding-top: 14px;
margin-right: 10px;
}
.panel-heading, .panel-title, .panel-title > h2 {
font-size: 1.2em;
margin: 0;
line-height: normal;
padding: 0;
...
.panel-heading img, .panel-title h2 {
display: inline-block;
vertical-align: top;
}
...
.panel-lien-right a:hover {
background-color: #004bf7;
}
.panel-heading .title img, .panel-heading .title h2 {
display: inline-block;
}

.aefy-tv .panel-heading {
height: 48px;
}
.item {
height: 278px;
...
.item-heading img, .item-heading h3 {
display: inline-block;
color: #fff;
margin: 0;
padding: 0;
...
.item-author-date, .item-readentire {
display: inline-block;
}
.item-prop a {
color: #004bf7;
...
.nav.navbar-nav > li:hover>a, .panel-navigation > li:hover > a {
background-color: #FFF;
color: #004fb7;
height: 100%;
width: 100%;
...
.pages-btns.page-active , .page-btns:hover{
background-color: #004bf7;
}
...
#register-page .btn, #login-page .btn
{
text-align: center;
margin: 0 auto;
}
